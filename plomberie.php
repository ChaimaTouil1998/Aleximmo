...
<head>
    <meta charset="utf-8">
    <title>Aleximmo - plomberie</title>
...
<body>
    <div class="p-0">
        ...
        <!-- Page Header Start -->
        <div class="container-fluid page-header mb-10 p-0" style="background-image: url(img/pb1.png);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 mb-3 animated slideInDown text-uppercase" style="color: #ffec00;">plomberie</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">plomberie</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="0.1s" id="5">
            <div class="container">
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        <form action="traitement_plomberie.php" method="post">
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <h1 style="text-align: center;">Devis plomberie</h1>
                                    ...
                                    <div class="col-md-3">
                                        <div class="date" id="date1" data-target-input="nearest">
                                            <input type="text" class="form-control" placeholder="Service : plomberie" data-target="#date1" data-toggle="datetimepicker" name="plomberie" style="box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); border-radius:15px;" disabled />
                                        </div>
                                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="color: #ffec00;">
                    ...
                    <h1 class="mb-5">Découvrez <span class="text-uppercase" style="color: #ffec00;">plomberie</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/pb1.png" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/pb2.webp">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/pb3.webp">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/pb4.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <p style="color: black; font-weight: bold;" class="text-center">
                                Chez Aleximmo, nous comprenons à quel point les problèmes de plomberie peuvent être stressants et perturbants. C'est pourquoi nous nous engageons à offrir un service de plomberie fiable, efficace et professionnel pour répondre à tous vos besoins en matière de plomberie résidentielle et commerciale.

                                Notre équipe de plombiers qualifiés et expérimentés est prête à intervenir rapidement pour résoudre vos problèmes de plomberie, que ce soit une fuite d'eau, un problème de robinetterie, un débouchage de canalisation, une installation de nouveaux équipements ou toute autre urgence de plomberie.

                                Nous mettons un point d'honneur à fournir un service de haute qualité, en utilisant des techniques et des équipements de pointe pour assurer des résultats durables. De plus, nous nous engageons à respecter les normes de sécurité les plus strictes pour garantir votre tranquillité d'esprit.

                                Que vous ayez besoin d'une intervention d'urgence ou d'une installation planifiée, notre équipe de plombiers professionnels est là pour vous aider à chaque étape du processus. Nous sommes à votre disposition pour répondre à toutes vos questions, évaluer vos besoins et vous fournir des solutions sur mesure adaptées à votre budget et à vos préférences.

                                Faites confiance à Aleximmo pour tous vos besoins en plomberie. Contactez-nous dès aujourd'hui pour bénéficier d'un service rapide, fiable et de qualité supérieure. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/pb5.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/pb6.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/pb7.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/pb8.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/pb9.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/pb10.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/pb10.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/pb11.jpeg">
                            </div>
                        </div>
                    </div>
                </div>
