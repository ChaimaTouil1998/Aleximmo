...
<head>
    <meta charset="utf-8">
    <title>Aleximmo - cuisine & dressing</title>
...
<body>
    <div class="p-0">
        ...
        <!-- Page Header Start -->
        <div class="container-fluid page-header mb-10 p-0" style="background-image: url(img/c3.jpeg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 mb-3 animated slideInDown text-uppercase" style="color: #ffec00;">cuisine & dressing</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">cuisine & dressing</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="0.1s" id="5">
            <div class="container">
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        <form action="traitement_cuisine&dressing.php" method="post">
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <h1 style="text-align: center;">Devis cuisine & dressing</h1>
                                    ...
                                    <div class="col-md-3">
                                        <div class="text " id="date1" data-target-input="nearest">
                                            <input type="text" class="form-control" placeholder="Hauteur" name="hauteur" style="box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); border-radius:15px;" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="text " id="date1" data-target-input="nearest">
                                            <input type="text" class="form-control" placeholder="Largeur" name="largeur" style="box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); border-radius:15px;" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="text " id="date1" data-target-input="nearest">
                                    ...
                                    <div class="col-md-3">
                                        <div class="date" id="date1" data-target-input="nearest">
                                            <input type="text" class="form-control" placeholder="Service : cuisine & dressing" data-target="#date1" data-toggle="datetimepicker" name="cuisine_dressing" style="box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); border-radius:15px;" disabled />
                                        </div>
                                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="color: #ffec00;">
                    ...
                    <h1 class="mb-5">Découvrez <span class="text-uppercase" style="color: #ffec00;">cuisine & dressing</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/c1.jpeg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/c2.jpeg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/c3.jpeg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/c4.jpeg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <p style="color: black; font-weight: bold;" class="text-center">
                                Le service de cuisine & dressing proposé par la société Aleximmo est un pilier essentiel de notre engagement envers le confort et le bien-être de nos clients. Forts de notre expertise et de notre engagement envers l'excellence, nous offrons des solutions de cuisine & dressing sur mesure pour une variété d'applications, que ce soit pour les résidences, les bureaux, les commerces ou les espaces industriels. Notre équipe expérimentée travaille en étroite collaboration avec nos clients pour évaluer leurs besoins spécifiques en matière de cuisine & dressing, en tenant compte de facteurs tels que la taille de l'espace, les préférences de température et les contraintes budgétaires. En utilisant les dernières technologies et en respectant les normes les plus élevées de l'industrie, nous concevons et installons des systèmes de cuisine & dressing efficaces et économes en énergie qui garantissent un confort optimal tout au long de l'année. De plus, notre service après-vente dédié assure une maintenance régulière et des réparations rapides pour assurer le bon fonctionnement continu de vos systèmes de cuisine & dressing. Avec le service de cuisine & dressing d'Aleximmo, vous pouvez compter sur une expertise professionnelle et un service clientèle exceptionnel pour répondre à tous vos besoins en matière de cuisine & dressing, vous offrant ainsi un environnement intérieur confortable et sain.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/c5.jpeg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/c6.jpeg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/c7.jpeg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/c8.jpeg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/c9.jpeg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/c10.jpeg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/c11.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/c12.ashx">
                            </div>
                        </div>
                    </div>
                </div>
