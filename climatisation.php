...
<head>
    <meta charset="utf-8">
    <title>Aleximmo - Climatisation</title>
...
<body>
    ...
    <?php include('inc/header.php') ?>
        ...
        <!-- Page Header Start -->
        <div class="container-fluid page-header mb-10 p-0" style="background-image: url(img/technicien-climatisation.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 mb-3 animated slideInDown text-uppercase" style="color: #ffec00;">Climatisation</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Climatisation</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-fluid booking pb-5 wow fadeIn" data-wow-delay="0.1s" id="5">
            <div class="container">
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        <form action="traitement_climatisation.php" method="post">
                            <div class="col-md-12">
                                <div class="row g-2">
                                    <h1 style="text-align: center;">Devis Climatisation</h1>
                                    ...
                                    <div class="col-md-3">
                                        <div class="date" id="date1" data-target-input="nearest">
                                            <input type="text" class="form-control" placeholder="Service : Climatisation" data-target="#date1" data-toggle="datetimepicker" name="climatisation" style="box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.5); border-radius:15px;" disabled />
                                        </div>
                                    </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="color: #ffec00;">
                    ...
                    <h1 class="mb-5">Découvrez <span class="text-uppercase" style="color: #ffec00;">Climatisation</span></h1>
                </div>
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/clim1.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/clim2.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/clim3.jfif">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/clim4.webp">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <p style="color: black; font-weight: bold;" class="text-center">
                                Le service de climatisation proposé par la société Aleximmo est un pilier essentiel de notre engagement envers le confort et le bien-être de nos clients. Forts de notre expertise et de notre engagement envers l'excellence, nous offrons des solutions de climatisation sur mesure pour une variété d'applications, que ce soit pour les résidences, les bureaux, les commerces ou les espaces industriels. Notre équipe expérimentée travaille en étroite collaboration avec nos clients pour évaluer leurs besoins spécifiques en matière de climatisation, en tenant compte de facteurs tels que la taille de l'espace, les préférences de température et les contraintes budgétaires. En utilisant les dernières technologies et en respectant les normes les plus élevées de l'industrie, nous concevons et installons des systèmes de climatisation efficaces et économes en énergie qui garantissent un confort optimal tout au long de l'année. De plus, notre service après-vente dédié assure une maintenance régulière et des réparations rapides pour assurer le bon fonctionnement continu de vos systèmes de climatisation. Avec le service de climatisation d'Aleximmo, vous pouvez compter sur une expertise professionnelle et un service clientèle exceptionnel pour répondre à tous vos besoins en matière de climatisation, vous offrant ainsi un environnement intérieur confortable et sain.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row g-5">
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/clim6.avif" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/clim7.webp">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/clim8.png">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/technicien-climatisation.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/clim10.jpeg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/clim11.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/clim12.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/clim13.jpg">
                            </div>
                        </div>
                    </div>
                </div>
